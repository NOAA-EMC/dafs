...
cp ${dafs_main}/fix/fix_2.3.0/*bin .
...
dafs_ifi=dafs.t${cycle}z.ifi.conus.f0${fhr}.grib2
dafs_gtg=dafs.t${cycle}z.gtg.conus.f0${fhr}.grib2

mv AVIATION.GrbF${fhr}  ${DAFS_FSCT}/${dafs_gtg}
...
###----- PRDGEN process and WMO header ----------------------
   ...
   ${prdgen_loc}/rrfs_subset_ifi_304m.sh_4_conus ${yyyymmdd} ${cycle} ${fhrx} ${DAFS_FSCT} ${dafs_ifi} ${dafs_main}
fi
