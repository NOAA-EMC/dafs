...
#--- Input Data
export datain=/lfs/h2/emc/ptmp/hsin-mu.lin/hrrr_tmp/hrrr_conus_fcst_prod_${cycle}
# export datain=/lfs/h2/emc/ptmp/emc.lam/hrrr_tmp/hrrr_alaska_fcst_prod_${cycle}
# export datain=/lfs/h2/emc/ptmp/hsin-mu.lin/HRRR/${cdate}

#--- Directory for All DAFS fcst
export datadir=/lfs/h2/emc/ptmp/$USER/DAFS_CONUS

#--- Directory for IFI
export DAFS_FSCT_IFI=${datadir}/${cdate}_ifi_conus
mkdir -p ${DAFS_FSCT_IFI}

#--- Directory for GTG
export DAFS_FSCT_GTG=${datadir}/${cdate}_gtg_conus
mkdir -p ${DAFS_FSCT_GTG}
...
cat > itag <<EOF
&model_inputs
fileName='${datain}/wrfout_d01_${YY}-${MM}-${DD}_${HH}_00_00'
IOFORM='netcdf'
grib='grib2'
...
mv IFIFIP.GrbF${fhr} ${cdate}-IFIFIP.GrbF${fhr}
mv *IFIFIP* ${DAFS_FSCT_IFI}

mv AVIATION.GrbF${fhr} ${cdate}-AVIATION.GrbF${fhr}
mv *AVIATION* ${DAFS_FSCT_GTG}
